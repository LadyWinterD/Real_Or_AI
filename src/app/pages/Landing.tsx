...
import database from '../data/database.json'; // ✅ 引入真实数据库
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black relative overflow-hidden">
      ...
      {/* Glow effect */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-500/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        <div className="max-w-4xl w-full text-center space-y-12 animate-in fade-in duration-700">
          ...
          {/* Stats Card */}
          <div className="max-w-md mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-[0_0_30px_rgba(0,229,255,0.1)] hover:shadow-[0_0_50px_rgba(0,229,255,0.2)] transition-shadow">
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-1">
                {/* ✅ 这里动态读取数据库的总案件数！ */}
                <div className="text-3xl font-bold text-cyan-400">{database.length}</div>
                <div className="text-xs text-gray-400 uppercase tracking-wider">Case Files</div>
              </div>
              <div className="space-y-1">
